	...
	return (
		<StyledSecondSection>
			...
			<div className='firstWrapper'>
				<div className='imageFirstKeyDiv'>
					<img
						src={image3}
				...
				<div className='blackOverlay'>
					<p className='blackOverlayParagraph'>
						...
						to becoming a full time poker player. As live poker started to open
						up again after covid, he was able to finally test his skills on the
						live circuits. After winning his first bracelet during WSOP’s online
						series during June of 2021 in the $3200 High Roller, he attended the
						World Series of Poker in Las Vegas during October. The first
						tournament registered was the Millionaire Maker, which he went on to
						beat over 5000 other entrants, win his 2nd bracelet, and top price
						of $1.000.000,00. 2021 finished with profits of well over 2, 5
						million!
						<br />
						<br />
						...
						than $482.000,00. He recently had a 3rd place finish in the Venom on
						Americas Card Room, as well as 3rd place finish in the $7.700,00
						online bracelet event to finish up his 2022. His profits for 2022
						are already nearing the 1,5 million mark as the 4th quarter is about
						to begin.
						<br />
						<br />
